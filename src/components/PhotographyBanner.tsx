        ...
        <main>
            ...
            <div className="left-part">
              <h1>
                <span className="d-flex">
                  {["В", "Ы", "П", "О", "Л", "Н", "Я", "Й"].map((char, index) => (
                ...
                <li className="feature-item">
                  ...
                  <div className="feature-text">
                    ...
                    <p className="font-light tracking-wider">
                      Вносишь свои планы на день, и твой тамагочи запомнит их все
                    </p>
                  </div>
                </li>
                <li className="feature-item">
                  <div className="feature-icon">🔔</div>
                  <div className="feature-text">
                    <h3>Получаешь напоминания</h3>
                    <p className="tracking-wider">
                      Аватар пришлёт уведомление с забавным комментарием, чтобы ты не забыл
                    </p>
                  </div>
                </li>
                <li className="feature-item">
                  <div className="feature-icon">✅</div>
                  <div className="feature-text">
                    <h3>Отмечаешь выполненное</h3>
                    <p className="tracking-wider">
                      Сделал задачу? Отметь её, и твой питомец порадуется вместе с тобой!
                    </p>
                  </div>
                </li>
                <li className="feature-item">
                  <div className="feature-icon">💔</div>
                  <div className="feature-text">
                    <h3>Следи за здоровьем</h3>
                    <p className="tracking-wider">
                      Забыл отметить задачу? Твой аватар потеряет здоровье и настроение
                    </p>
                  </div>
                </li>
              </ul>
          ...
          <section className="testimonials-section">
            <div className="testimonials-container">
              <h2 className="testimonials-title">Что говорят пользователи</h2>
              <div className="testimonials-marquee">
                <div className="testimonial-card">
                  <p className="testimonial-quote">
                    "Наконец-то я не забываю про задачи! Мой тамагочи напоминает мне о важном с юмором. Это реально мотивирует!"
                  </p>
                  <div className="testimonial-author">
                    <div className="author-avatar">АП</div>
                ...
                <div className="testimonial-card">
                  <p className="testimonial-quote">
                    "Игровая механика с здоровьем аватара — гениально! Теперь мне действительно важно выполнить задачу."
                  </p>
                  <div className="testimonial-author">
                    <div className="author-avatar">ИК</div>
                    <div className="author-info">
                      <h4>Игорь Кузнецов</h4>
                      <p>Студент</p>
                    </div>
                  </div>
                </div>
                <div className="testimonial-card">
                  <p className="testimonial-quote">
                    "Комментарии аватара просто убивают! Это как личный ассистент, только веселее."
                  </p>
                  <div className="testimonial-author">
          ...
          <section className="cta-section" id="cta">
            <div className="cta-container">
              <h2 className="cta-title text-center">Готов начать?</h2>
